<template>
  <div id="helper-container">
      <div id="prescript-helper" v-if="toggle_helper"
           class="p-4 mx-auto h-full min-w-[16rem] dark:text-white break-all dark:bg-gray-700 border border-gray-500
           rounded-lg m-0 overflow-clip flex-1">
        ...
        <div class="modal-header flex flex-shrink-0 items-center justify-between p-2 border-b border-gray-500
          ...
          <button @click="toggle_helper = !toggle_helper"
