		...
		<div class="flex gap-10">
			<div class="flex-1 max-w-[48rem] min-w-[18rem] mx-auto">
				...
				<div class="grid md:grid-cols-4 gap-x-6">
					...
					<div class="flex items-center pl-4 mb-6 rounded border border-gray-200 dark:border-gray-700">
						...
						<label for="bordered-radio-1"
							class="py-2.5 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">여성</label>
					</div>
					<div class="flex items-center pl-4 mb-6 rounded border border-gray-200 dark:border-gray-700">
						<input id="bordered-radio-2" type="radio" v-model="p_sex" value="male" name="bordered-radio"
							class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
						<label for="bordered-radio-2"
							class="py-2.5 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">남성</label>
					</div>
				</div>
				...
				<textarea id="pre_script" rows="4" v-model="p_pre_script"
					class="block p-2.5 mb-6 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
					placeholder="사전 문진내역"></textarea>
